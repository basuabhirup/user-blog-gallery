...
class UserGallery extends React.Component {
    constructor(props){
        ...
        this.state={
            ...
            isloading: false,
            currentPage: 0
//Parent Class properties with key & value pairs are defiend
        };
    }

//lifecycle method of React which is called for 
            //only once after first render method is called:
    componentDidMount = ()=>{
//executed to fetch users when the page loads:
        this.fetchUsers();
    };
